...
import com.example.gactour.ui.presentation.viewModels.LocationViewModel_HiltModules_KeyModule_ProvideFactory;
import com.example.gactour.ui.presentation.viewModels.MapViewModel;
import com.example.gactour.ui.presentation.viewModels.MapViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerMainApplication_HiltComponents_SingletonC extends MainApplication_HiltComponents.SingletonC {
  ...
  private static final class ActivityCImpl extends MainApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(2).add(LocationViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(MapViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends MainApplication_HiltComponents.ViewModelC {
    ...
    private LocationManager locationManager() {
      return new LocationManager(ApplicationContextModule_ProvideContextFactory.provideContext(singletonC.applicationContextModule));
    }
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam) {
      this.locationViewModelProvider = new SwitchingProvider<>(singletonC, activityRetainedCImpl, viewModelCImpl, 0);
      this.mapViewModelProvider = new SwitchingProvider<>(singletonC, activityRetainedCImpl, viewModelCImpl, 1);
    }

    @Override
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(2).put("com.example.gactour.ui.presentation.viewModels.LocationViewModel", (Provider) locationViewModelProvider).put("com.example.gactour.ui.presentation.viewModels.MapViewModel", (Provider) mapViewModelProvider).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.gactour.ui.presentation.viewModels.LocationViewModel 
          return (T) viewModelCImpl.locationViewModel();

          case 1: // com.example.gactour.ui.presentation.viewModels.MapViewModel 
