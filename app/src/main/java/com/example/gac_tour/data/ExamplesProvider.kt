package com.example.gac_tour.data
...
import com.example.gac_tour.ExampleOverviewActivity
import com.example.gac_tour.model.ExampleCategory
import com.example.gac_tour.model.ExampleEntry
...
public object ExamplesProvider {
  ...
  private fun loadExamplesFromManifest(context: Context): List<SpecificExample> {
    ...
    val metaDataKey = context.getString(R.string.category)
